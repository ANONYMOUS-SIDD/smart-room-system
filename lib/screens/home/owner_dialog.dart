  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      final Map<String, dynamic> roomDoc = {
        'distance': int.tryParse(_distanceController.text.trim()) ?? null,
  ...
  Widget _buildImageStrip() {
    ...
    return ListView.separated(
      ...
      itemBuilder: (context, idx) {
        ...
        return Stack(
          children: [
            ClipRRect(borderRadius: BorderRadius.circular(12), child: Image.file(imgFile, width: 140, height: 86, fit: BoxFit.cover)),
            Positioned(
              top: 6,
              right: 6,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          const SizedBox(height: 8),
          Text("Add At Most 6 Images", style: GoogleFonts.quicksand(fontSize: 11, fontWeight: FontWeight.w700, color: Colors.grey.shade800)),
        ]),
      ),
    );
  }
      ...
      child: Column(children: [
        _buildRowInput(
          ...
          validator: (value) {
            ...
            if (int.parse(value.trim()) <= 0) return 'Distance Must Be Greater Than 0';
            return null;
          },
        ),
                ...
                return Column(
                  ...
                  children: [
                    TextFormField(
                      ...
                      style: GoogleFonts.quicksand(fontSize: 14, fontWeight: FontWeight.w600, color: Colors.black),
                      decoration: InputDecoration(
                        contentPadding: const EdgeInsets.symmetric(vertical: 14),
                        hintText: label,
                        hintStyle: GoogleFonts.quicksand(fontSize: 13, fontWeight: FontWeight.w700, color: Colors.grey.shade700),
                        suffixText: showSuffix ? hintSuffix : null,
                        suffixStyle: GoogleFonts.quicksand(fontSize: 13, fontWeight: FontWeight.w700, color: Colors.grey.shade700),
                        border: InputBorder.none,
                        enabledBorder: InputBorder.none,
                        focusedBorder: InputBorder.none,
                        errorStyle: GoogleFonts.quicksand(fontSize: 11, fontWeight: FontWeight.w700, color: Colors.red.shade600),
                      ),
                      validator: validator,
                    ),
                  ],
      ...
      child: Column(children: [
        Padding(
          ...
          child: Row(children: [
            ...
            Text("Water Availability", style: GoogleFonts.quicksand(fontSize: 14, fontWeight: FontWeight.w700)),
          ]),
        ),
        Padding(
        ...
        Padding(
          ...
          child: Row(children: [
            ...
            const SizedBox(width: 8),
            Text("Sunlight", style: GoogleFonts.quicksand(fontSize: 14, fontWeight: FontWeight.w700)),
          ]),
        ),
        Padding(
          padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
        ...
        Padding(
          ...
          child: Row(children: [
            ...
            const SizedBox(width: 8),
            Text("Attached Bathroom", style: GoogleFonts.quicksand(fontSize: 14, fontWeight: FontWeight.w700)),
          ]),
        ),
        Padding(
    ...
    return Container(
      ...
      child: Row(
        children: List.generate(options.length, (i) {
          ...
          return Expanded(
            child: Padding(
              padding: EdgeInsets.only(left: i == 0 ? 0 : 6, right: i == options.length - 1 ? 0 : 6),
              child: GestureDetector(
                onTap: () => onChanged(opt),
                child: AnimatedContainer(
                  ...
                  child: Text(
                    opt,
                    textAlign: TextAlign.center,
                    style: GoogleFonts.quicksand(fontSize: 13, fontWeight: FontWeight.w700, color: selected ? Colors.white : Colors.grey.shade800),
                  ),
                ),
              ),
            ),
          ...
          child: Ink(
            ...
            child: Container(
              ...
              child: _isUploading
                ...
                Text("Publish Room Listing", style: GoogleFonts.quicksand(fontSize: 16, fontWeight: FontWeight.w700, color: Colors.white)),
              ]),
            ),
          ),
        ),
  ...
  Widget build(BuildContext context) {
    return Dialog(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(color: const Color(0xFFF8F9FA), borderRadius: const BorderRadius.only(topLeft: Radius.circular(24), topRight: Radius.circular(24))),
        child: Column(children: [
          _buildHeader(),
          Expanded(
            child: Form(
